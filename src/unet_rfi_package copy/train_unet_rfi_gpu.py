...
def main():
    ...
    _default_dataset_dir = os.path.normpath(os.path.join(_here, "..", "..", "data", "synthetic", "Synthetic Dataset"))
    _default_output_dir = os.path.normpath(os.path.join(_here, "..", "..", "runs", "unet", "unet_run_gpu"))

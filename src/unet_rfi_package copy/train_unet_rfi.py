...
def train(args):
    ...
    val_provider = RFINpyDataProvider(
        os.path.join(args.dataset_dir, "val", "images"),
        os.path.join(args.dataset_dir, "val", "masks"),
        shuffle_data=False,
    )
...
def main():
    ...
    parser.add_argument("--dataset_dir", default="/home/claude/6_Simulated_Dataset",
                         help="Root of the dataset (must contain train/, val/, test/ subfolders)")
    parser.add_argument("--output_dir", default="/home/claude/unet_run")

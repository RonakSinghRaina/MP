...
def main():
    ...
    p.add_argument("--dataset_dir", default=os.path.normpath(os.path.join(_here, "..", "..", "data", "synthetic", "Synthetic Dataset")))
    p.add_argument("--output_dir", default=os.path.normpath(os.path.join(_here, "..", "..", "runs", "hybrid", "hybrid_run")))

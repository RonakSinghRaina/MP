...
USAGE
    ...
    python3 analysis/hera_transfer_test/finetune_on_hera.py --init pretrained
    python3 analysis/hera_transfer_test/finetune_on_hera.py --init scratch
...
def main():
    ...
    p.add_argument("--checkpoint", default=os.path.join(_ROOT, "runs", "hybrid", "hybrid_run_paperdim", "best.pt"))
    ...
    if os.path.exists(other):
        ...
        print("  python3 analysis/hera_transfer_test/finetune_on_hera.py --init {} \\".format(

...
def main():
    ...
    print("  python3 analysis/hera_transfer_test/finetune_on_hera.py --init pretrained \\")
    print("      --data_dir analysis/hera_transfer_test/HERA_npy_clean --fresh")
    print("  python3 analysis/hera_transfer_test/finetune_on_hera.py --init scratch \\")
    print("      --data_dir analysis/hera_transfer_test/HERA_npy_clean --fresh")

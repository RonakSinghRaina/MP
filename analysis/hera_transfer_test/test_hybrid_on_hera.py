...
def main():
    ...
    p.add_argument("--pkl", default=os.path.join(_ROOT, "data/hera/HERA_04-03-2022_all.pkl"))
    p.add_argument("--checkpoint", default=os.path.join(_ROOT, "runs", "hybrid", "hybrid_run_paperdim", "best.pt"))
    p.add_argument("--progress", default=os.path.join(_ROOT, "runs", "hybrid", "hybrid_run_paperdim", "progress.json"))

...
## Checkpoint Forensics — Genuinely Trained
...
## Every Metric Recomputed by Hand
...
## RFI Fraction — Three Independent Code Paths Agree Exactly
...
## Overfitting — Evidence Against It
...
## Degenerate Strategies Ruled Out
...
## Visual Spot-Check — Looks Like Real Detection

*See panel (`spotcheck_panel.png`)*
